...
(function (window, $, undefined) {
  ...
  (function () {
    var VERSION = '2.2.3',
      ...
      navTitles: {
        days: '<span class="datepicker-year"><i>yyyy</i>년</span> <span class="datepicker-month">MM</span>',
        months: 'yyyy',
        years: 'yyyy1 - yyyy2'
      },
      // timepicker
    ...
    datepicker.prototype = {
      ...
      _onShowEvent: function _onShowEvent(e) {
        if (e.currentTarget.className.indexOf('big_calendar') > -1) {// this.sizeType = 'big';
        }
    ...
    $.fn.datepicker.language = {
      ko: {
        days: ['일요일1', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'],
